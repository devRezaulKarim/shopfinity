    ...
    <>
      <div className="bg-primary/10 border-b">
        <div className="container flex items-center justify-between py-4">
          ...
          <div className="flex grow items-center justify-center gap-x-4">
            ...
            <div className="text-primary flex h-full items-center gap-x-2 rounded-full bg-white px-4 py-2 font-medium">
              <MapPin size={20} />
              <span>Dhaka</span>
            </div>
          </div>
      ...
      <div className="border-b">
        <div className="container flex items-center justify-between">
          ...
          <div className="bg-primary flex items-center gap-x-2 px-4 py-2 font-medium text-white">
            <PhoneIcon size={20} />
